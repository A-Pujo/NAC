    ...
    <div class="flex space-y-16 flex-col p-24 sticky top-8 z-50">
        <div class="alert alert-info" x-data="{active: true}" x-show="active">
            <div class="flex-1">
                ...
                <label>Tonton video tutorial pelaksanaan Preliminary Round <a class="btn btn-xs" href="<?= base_url('guide?halaman=acc-sma-prelim') ?>">disini!</a></label>
            </div>
            <svg
                @click="active = false"
        ...
        <div class="alert alert-info" x-data="{active: true}" x-show="active">
            <div class="flex-1">
                ...
                <label>Persiapan Preliminary Round dilaksanakan pada hari Minggu, 10 Oktober 2021 pukul 09:00 - 09:30. Peserta dapat mengambil voucher Preliminary Round pada Dashboard masing-masing. </label>
            </div>
            <svg
                @click="active = false"
                xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 cursor-pointer" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div class="alert alert-info" x-data="{active: true}" x-show="active">
            <div class="flex-1">
                ...
                <label>Pengerjaan soal Preliminary Round dilaksanakan pada hari Minggu, 10 Oktober 2021 pukul 09:30 - 10:30</label>
            </div>
            <svg
                @click="active = false"
                xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 cursor-pointer" viewBox="0 0 20 20" fill="currentColor">

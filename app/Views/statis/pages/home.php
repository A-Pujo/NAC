...
<?= $this->section('content') ?>
    ...
    <div class="mt-96 flex justify-center">
        <div class="relative 
            ...
            <figure class="rounded-lg overflow-hidden">
                <img src="https://picsum.photos/id/1001/560/370" alt=""> 
            </figure>
            <div class="absolute px-32 py-16 text-base-100 -left-32 -bottom-32 font-bold rounded-md text-24 bg-neutral-100 shadow-sm hidden sm:block">
                Perlombaan
            </div>
            <div class="absolute px-32 py-16 text-base-100 -right-32 -bottom-32 font-bold rounded-md text-24 bg-neutral-100 shadow-sm">
    ...
    <div class="flex justify-center mt-96">
        <div class=" text-base-100 grid grid-cols-1 sm:grid-cols-2 justify-items-center w-full sm:w-590 gap-x-16 gap-y-24 px-24">
            ...
            <div class="bg-neutral-100 rounded-md shadow-sm p-24 text-center">
                ...
                <p class="text-16">Dari sekolah manapun, dari kelas 10-12, perempuan & laki-laki, Grup maupun Individu, </p>
            </div>
            <div class="bg-neutral-100 rounded-md shadow-sm p-24 text-center">
                <h2 class="font-bold text-18">Perguruan Tinggi </h2>
                <p class="text-16">Dari PT manapun, jurusan apa saja, tingkat berapapun, grup maupun individu. Panitia jangan!</p>
            </div>
    ...
    <div class="mt-96 flex flex-col items-center overflow-hidden">
        ...
        <div class="text-base-500 text-center">
            <span classt="text-14">Geser-geser atau</span>
        ...
        <div class="relative w-full flex justify-between items-center mt-24 h-112 max-w-1000" 
            ...
            <button  class="btn z-10 btn-ghost" @click=" active += 1">
            ...
            <template x-for="item in tl">
                <div 
                    ...
                    class="z-0 transition duration-1000 left-timeline transform top-0 absolute p-32 bg-primary-100 rounded-md flex justify-center items-center  w-279 h-112 flex items-center justify-between">
                    <div class="text-base-100 bg-neutral-400 rounded-full h-64 w-64 text-center">
                        <p x-text="item.tanggal" class="font-bold text-24"></p>
                        <p x-text="item.bulan" class="text-10"></p>
                    </div>
                    <div class="text-neutral-100">
                        <h3 class="font-bold text-18" x-text="item.judul"></h3>
    ...
    <div class="mt-96 flex flex-col items-center px-16">
        ...
        <p class="text-base-500 mt-4 mb-8">Frequented Asked Question</p>
        <div class="w-ful md:w-640"
            x-data="{
                faq: [
                    {
                        tanya : 'pertanyaan 1',
                        jawab : 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora eligendi veniam voluptas rerum sed culpa voluptatum?',
                        id : 1
                    },
                    {
                        tanya : 'pertanyaan 2',
                        jawab : 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora eligendi veniam voluptas rerum sed culpa voluptatum? Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora eligendi veniam voluptas rerum sed culpa voluptatum?',
                        id : 2
                    },
                    {
                        tanya : 'pertanyaan 3',
        ...
        <template x-for="i in faq">
            <div class="h-auto">
                <div 
                    class="text-base-100 flex justify-between py-24 px-32 rounded-md border-2 border-neutral-80 cursor-pointer mt-32"
                    @click="active = i.id"
                    >

    ...
    <div class="flex space-y-16 flex-col p-24 sticky top-8 z-50">
        <div class="alert alert-info" x-data="{active: true}" x-show="active">
            <div class="flex-1">
                ...
                <label>Pengumuman hasil Preliminary Round dapat Anda lihat di <a class="btn btn-xs btn-primary" href="<?= base_url('pengumuman') ?>">Pengumuman</a> pada hari Selasa, 12 Oktober 2021 pukul 20:00</label>
            </div>
            <svg
                @click="active = false"

...
<!-- === END PENGUMUMAN === -->
                ...
                <?php $no= 2; for($i=0; $i < 11; $i++):?>
                    ...
                    <?php if($no == 10 ):?>
                        ...
                        <tr>
                            ...
                            <?php else :?>
                                <td><span class="verif-sukses">Berkas berhasil diunggah</span></td>
                                <td><a class="btn btn-xs btn-primary" target="_blank" href="<?= base_url('uploads/partisipan/lomba/berkas/'.$peserta_nilai->berkas_2) ?>">Lihat berkas</a></td>
                            <?php endif?>
                        </tr>
                    <?php endif ?>
                    <?php if($no == 14 ):?>
    ...
    <table class="tabel">
        ...
        <tbody>
            <?php 
                $nilai = [
                    [$peserta_nilai->segmen_1 + $peserta_nilai->segmen_2 + $peserta_nilai->segmen_3,'Preliminary Round'],
                    [$peserta_nilai->nilai_1,'Fast Furious'],
                    [$peserta_nilai->nilai_2,'Fun Games - Fill the Blank'],
                    [$peserta_nilai->nilai_3,'Fun Games - Mistery Box'],
                    [$peserta_nilai->nilai_4,'Breakdown the Case'],
                    [
                        $peserta_nilai->nilai_1 * 0.2 +
                        $peserta_nilai->nilai_2 * 0.15 +

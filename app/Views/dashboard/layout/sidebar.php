<div class="sticky top-0 flex flex-col space-y-2 p-32 items-stretch space-y-16">
    ...
    <?php elseif(isInRole('tim registrasi')) : ?>
        <a href="<?= base_url('/dashboard/verifikasi-pendaftaran') ?>" class="<?= $halaman == 'kelola-pendaftaran' ? 'sidebar-menu-aktif' : 'sidebar-menu' ?>">
        <span class="sidebar-text">Verifikasi Pendaftaran</span>
    </a>

    <!-- Tim Bendahara -->
    <?php elseif(isInRole('tim bendahara')) : ?>
        <a href="<?= base_url('/dashboard/verifikasi-pembayaran') ?>" class="<?= $halaman == 'kelola-pembayaran' ? 'sidebar-menu-aktif' : 'sidebar-menu' ?>">
            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#FCFEFF"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v1c0 .55.45 1 1 1h14c.55 0 1-.45 1-1v-1c0-2.66-5.33-4-8-4z"/></svg>
            <span class="sidebar-text">Verifikasi Pembayaran</span>
        </a> 

...
<div class="sticky top-0 flex flex-col space-y-16 p-32 sidebar h-screen relative overflow-auto"
    ...
    <?php if($role_user == 'tim registrasi') : ?>
        ...
        <!-- Kursus -->
        <a href="<?= base_url('/dashboard/regis-kursus') ?>" class="<?= $halaman == 'regis-kursus' ? 'aktif' : 'nonaktif' ?>">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                <path d="M3 12v3c0 1.657 3.134 3 7 3s7-1.343 7-3v-3c0 1.657-3.134 3-7 3s-7-1.343-7-3z" />
                <path d="M3 7v3c0 1.657 3.134 3 7 3s7-1.343 7-3V7c0 1.657-3.134 3-7 3S3 8.657 3 7z" />
                <path d="M17 5c0 1.657-3.134 3-7 3S3 6.657 3 5s3.134-3 7-3 7 1.343 7 3z" />
        ...
        <!-- Pendaftaran Lomba -->
        <a href="<?= base_url('/dashboard/regis-peserta') ?>" class="<?= $halaman == 'regis-peserta' ? 'aktif' : 'nonaktif' ?>">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                <path d="M3 12v3c0 1.657 3.134 3 7 3s7-1.343 7-3v-3c0 1.657-3.134 3-7 3s-7-1.343-7-3z" />
                <path d="M3 7v3c0 1.657 3.134 3 7 3s7-1.343 7-3V7c0 1.657-3.134 3-7 3S3 8.657 3 7z" />
                <path d="M17 5c0 1.657-3.134 3-7 3S3 6.657 3 5s3.134-3 7-3 7 1.343 7 3z" />
            </svg>
            <span>Data Pendaftaran Peserta</span>
        </a>
    <?php endif ?>

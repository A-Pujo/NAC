...
class M_Partisipan extends Model
{
    ...
    protected $allowedFields = ['user_id', 'pt', 'nama_tim', 'nama_ketua', 'nama_1', 'nama_2', 'partisipan_jenis', 'wa', 'provinsi', 'file_abstrak', 'surat_pernyataan', 'ktm', 'twibbon', 'partisipan_aktif', 'partisipan_ditolak', 'id_tim_regis', 'pertama_input'];
